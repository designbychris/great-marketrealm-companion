 ...
 *
 * CharacterRepository is in this namespace, so PHP will use these
 * functions before looking for global WordPress functions.
 */
namespace GreatMarketrealmCompanion\Modules\Characters\Repositories {
    ...
    function get_posts(array $arguments = []): array
    {
        ...
        return array_values(
            array_filter(
                $posts,
                static function (WP_Post $post) use ($arguments): bool {
                    if (
                        isset($arguments['post_type'])
                        && $post->post_type !== $arguments['post_type']
                    ) {
                        return false;
                    }
                    ...
                    if (
                        ...
                        && $post->post_status !== $arguments['post_status']
                    ) {
                        return false;
                    }
                    ...
                    if (
                        ...
                        && $post->post_author !== (int) $arguments['author']
                    ) {
                        return false;
                    }
                    ...
                    if (
                        ...
                        $stored = CharacterRepositoryWordPressState::$meta[
                            $post->ID
    ...
    function wp_insert_post(
        ...
        $postId = CharacterRepositoryWordPressState::$nextPostId++;
    ...
    function update_post_meta(
        ...
        CharacterRepositoryWordPressState::$meta[$postId][$key] =
            $value;
    ...
    function get_post_meta(
        ...
        return CharacterRepositoryWordPressState::$meta[$postId][$key]
            ?? '';
    }
