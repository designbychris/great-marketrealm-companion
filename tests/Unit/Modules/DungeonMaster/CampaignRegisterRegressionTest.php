...
final class CampaignRegisterRegressionTest extends TestCase
{
 ...
 public function testCampaignRegisterHasAccessibleResponsiveStyles(): void { $css=file_get_contents($this->root.'/assets/css/modules/dungeon-master/campaign-register.css');$this->assertStringContainsString(':focus-visible',$css);$this->assertStringContainsString('forced-colors:active',$css);$this->assertStringContainsString('prefers-reduced-transparency:reduce',$css); }
