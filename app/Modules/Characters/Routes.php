...
return static function (
    ...
    $router->post(
        '/characters/{id}/metamagic/use',
        [CharacterController::class, 'useMetamagic']
    );

    $router->post(
        '/characters/{id}/sorcery/spend',
        [CharacterController::class, 'spendSorceryPoints']
    );

    $router->post(
        '/characters/{id}/sorcery/convert',
        [CharacterController::class, 'convertSorceryReserve']
    );

    $router->post(
        '/characters/{id}/sorcery/rest',
        [CharacterController::class, 'restSorceryReserves']
    );
    ...
    $router->post(
        ...
        [CharacterController::class, 'spendSacredReserve']
    );

    $router->post(
        '/characters/{id}/sacred/rest',
        [CharacterController::class, 'restSacredReserves']
    );
