...
final class DungeonMasterServiceProvider extends ServiceProvider
{
 public function register(): void {
  $this->app->singleton(DungeonMasterAccess::class);$this->app->singleton(CampaignCommandCentre::class);$this->app->singleton(InviteCodeGenerator::class);$this->app->singleton(CampaignRepository::class);$this->app->singleton(CampaignRosterRepository::class);$this->app->singleton(PlayerCampaignRepository::class);$this->app->singleton(MarketPassRepository::class);$this->app->singleton(CampaignFellowshipRepository::class);$this->app->singleton(CampaignFellowshipService::class);$this->app->singleton(CampaignMembershipSynchronizer::class);$this->app->singleton(SessionRepository::class);$this->app->singleton(EncounterRepository::class);$this->app->singleton(MonsterRepository::class);$this->app->singleton(CanonicalBestiary::class);$this->app->singleton(JournalRepository::class);
 ...
 public function boot(): void { add_action('init',[$this,'registerPostType']); add_filter('gmrc_tabletop_bestiary_records',[$this,'tabletopBestiaryRecords']); }
