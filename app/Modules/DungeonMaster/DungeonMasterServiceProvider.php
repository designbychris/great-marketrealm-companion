...
final class DungeonMasterServiceProvider extends ServiceProvider
{
 public function register(): void {
  $this->app->singleton(DungeonMasterAccess::class);$this->app->singleton(CampaignRepository::class);$this->app->singleton(CampaignRosterRepository::class);$this->app->singleton(SessionRepository::class);$this->app->singleton(EncounterRepository::class);$this->app->singleton(MonsterRepository::class);
  ...
  $this->app->bind(MonsterController::class,static fn(Container $c): MonsterController=>new MonsterController($c->make(MonsterRepository::class),$c->make(DungeonMasterAccess::class),$c->make(ViewFactory::class),$c->make(ResponseFactory::class),$c->make(FlashStore::class)));
  $this->app->bind(EncounterController::class,static fn(Container $c): EncounterController=>new EncounterController($c->make(CampaignRepository::class),$c->make(EncounterRepository::class),$c->make(SessionRepository::class),$c->make(CampaignRosterRepository::class),$c->make(CharacterRepository::class),$c->make(MonsterRepository::class),$c->make(DungeonMasterAccess::class),$c->make(ViewFactory::class),$c->make(ResponseFactory::class),$c->make(FlashStore::class)));
 }
