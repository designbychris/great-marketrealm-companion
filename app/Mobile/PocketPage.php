...
function pocketDashboard(detail,character,back,diceTray){
 ...
 more.addEventListener('click',()=>{const opening=moreMenu.hidden;moreMenu.hidden=!opening;more.setAttribute('aria-expanded',opening?'true':'false');});
 ...
 shell.append(hero,tabs,moreMenu,...panels.values(),dock);detail.replaceChildren(back,shell);root.classList.add('gmrc-pocket--character-open');
}
