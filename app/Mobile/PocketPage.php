...
function pocketDashboard(detail,character,back,diceTray){
 ...
 const bottomDock=el('div','gmrc-pocket-bottom-dock');bottomDock.setAttribute('aria-label','Pocket controls');bottomDock.append(dock,moreMenu,tabs);shell.append(hero,...panels.values(),bottomDock);detail.replaceChildren(back,shell);root.classList.add('gmrc-pocket--character-open');
}
